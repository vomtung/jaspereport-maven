...
public class LineChart {
	...
	public LineChart(String sourceFileName) {
		super();
		this.sourceFileName = sourceFileName;
	}

	public LineChart(String jasperSrcFile, String jprintSrcFile) {
		super();
	...
	{
		LineChart imageapp=new LineChart("src/jasper/LineChart.jrxml");
		try{
